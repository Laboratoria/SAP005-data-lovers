...
//DOM, nós, registro de manejadores de eventos (event listeners ou event handlers)
  ...
  const opcoesEpisodios = document.getElementById("episodes")
  ...
  const opcoesEspecies = document.getElementById("species")
  ...
  const opcoesDimensoes = document.getElementById("dimensions")
